...
kaggle_data %<>% filter(sentiment != 'neutral')
set.seed(1993)
...
mean(ifelse(pred > 0.5, 'positive', 'negative') == kaggle_test$sentiment)


keras::save_model_hdf5(kaggle_model, 'DeepLearnModel/kaggle_binary_model.hdf5')
